        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                ...
                <CardContent className="p-6">
                  <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                    <TabsList className="grid w-full grid-cols-5 bg-white/10 border border-white/20">
                      <TabsTrigger value="personal" className="text-white data-[state=active]:bg-white/20">Personal</TabsTrigger>
                      <TabsTrigger value="education" className="text-white data-[state=active]:bg-white/20">Education</TabsTrigger>
                      <TabsTrigger value="experience" className="text-white data-[state=active]:bg-white/20">Experience</TabsTrigger>
                    ...
                    <TabsContent value="personal" className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                          <label className="text-white text-sm font-medium">LinkedIn</label>
                          <Input
                        ...
                        <div className="md:col-span-2 space-y-2">
                          <label className="text-white text-sm font-medium">Professional Summary</label>
                          <Textarea
                    ...
                    <TabsContent value="education" className="space-y-6">
                      <div className="flex justify-between items-center">
                        ...
                        <Button onClick={addEducation} variant="outline-hero" size="sm">
                          <Plus className="w-4 h-4 mr-2" />
                          Add Education
                        </Button>
                      </div>
                      {education.map((edu, index) => (
                        <Card key={edu.id} className="bg-white/10 backdrop-blur-sm border-white/20 shadow-lg">
                          <CardContent className="p-6">
                            <div className="flex justify-between items-start mb-6">
                              <h4 className="text-white font-medium text-lg">Education #{index + 1}</h4>
                              <Button
                                variant="destructive"
                                size="sm"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              ...
                              <div className="space-y-2">
                                <label className="text-white text-sm font-medium">Field of Study</label>
                                <Input
                                  value={edu.field}
                              ...
                              <div className="space-y-2">
                                <label className="text-white text-sm font-medium">GPA</label>
                                <Input
                                  value={edu.gpa}
                     ...
                     <TabsContent value="experience" className="space-y-6">
                       <div className="flex justify-between items-center">
                         <h3 className="text-white text-lg font-semibold">Work Experience</h3>
                                                 <Button onClick={addExperience} variant="outline-hero" size="sm">
                          <Plus className="w-4 h-4 mr-2" />
                          Add Experience
                        </Button>
                       </div>
                       {experience.map((exp, index) => (
                         <Card key={exp.id} className="bg-white/10 backdrop-blur-sm border-white/20 shadow-lg">
                           <CardContent className="p-6">
                             <div className="flex justify-between items-start mb-6">
                               <h4 className="text-white font-medium text-lg">Experience #{index + 1}</h4>
                               <Button
                                 variant="destructive"
                                 size="sm"
                             ...
                             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                               ...
                               <div className="flex items-center space-x-2">
                                 <label className="text-white text-sm font-medium">Current Position</label>
                                 <input
                                   type="checkbox"
                                   checked={exp.current}
                     ...
                     <TabsContent value="skills" className="space-y-6">
                       <div className="flex justify-between items-center">
                         <h3 className="text-white text-lg font-semibold">Skills</h3>
                                                 <Button onClick={addSkill} variant="outline-hero" size="sm">
                          <Plus className="w-4 h-4 mr-2" />
                          Add Skill
                        </Button>
                       </div>
                       {skills.map((skill, index) => (
                         <Card key={skill.id} className="bg-white/10 backdrop-blur-sm border-white/20 shadow-lg">
                           <CardContent className="p-6">
                             <div className="flex justify-between items-start mb-6">
                               <h4 className="text-white font-medium text-lg">Skill #{index + 1}</h4>
                               <Button
                                 variant="destructive"
                                 size="sm"
                             ...
                             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                               ...
                               <div className="space-y-2">
                                 ...
                                 <select
                                   ...
                                   className="w-full bg-white/10 border-white/20 text-white rounded-md px-3 py-2 focus:border-white/40 focus:ring-white/20"
                                 >
                     ...
                     <TabsContent value="projects" className="space-y-6">
                       <div className="flex justify-between items-center">
                         <h3 className="text-white text-lg font-semibold">Projects</h3>
                                                 <Button onClick={addProject} variant="outline-hero" size="sm">
                          <Plus className="w-4 h-4 mr-2" />
                          Add Project
                        </Button>
                       </div>
                       {projects.map((project, index) => (
                         <Card key={project.id} className="bg-white/10 backdrop-blur-sm border-white/20 shadow-lg">
                           <CardContent className="p-6">
                             <div className="flex justify-between items-start mb-6">
                               <h4 className="text-white font-medium text-lg">Project #{index + 1}</h4>
                               <Button
                                 variant="destructive"
                                 size="sm"
                             ...
                             <div className="space-y-6">
                               ...
                               <div className="space-y-2">
                                 <label className="text-white text-sm font-medium">Technologies (comma-separated)</label>
                                 <Input
                               ...
                               <div className="space-y-2">
                                 <label className="text-white text-sm font-medium">Project Link</label>
                                 <Input
                                   value={project.link}
            ...
            <div className="lg:col-span-1">
              <Card className="bg-white/10 backdrop-blur-sm border-white/20 shadow-xl sticky top-8">
                <CardHeader className="border-b border-white/10">
                  <CardTitle className="text-white text-xl font-semibold">Resume Preview</CardTitle>
                </CardHeader>
                <CardContent className="space-y-6 p-6">
                  <div className="space-y-3">
                    ...
                    <Button 
                      ...
                      className="w-full border-white/20 text-white hover:text-white hover:border-white/40 bg-white/5"
                    >
                  ...
                  <div className="space-y-4">
                    <h4 className="text-white font-semibold">Current Template</h4>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-300 text-sm">Template</span>
                      <Badge variant="default" className="capitalize bg-blue-600/20 text-blue-300 border-blue-500/30">
