...
const Chat: React.FC = () => {
  return (
    <div className="container mx-auto px-4 py-8 bg-gradient-subtle text-white min-h-screen">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-center mb-4">
          <div className="bg-gradient-to-r from-indigo-600/30 to-purple-600/30 text-indigo-300 text-xs font-medium px-4 py-2 rounded-full flex items-center shadow-glow">
        ...
        <h1 className="text-responsive-2xl font-bold text-center mb-4 bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-purple-400">Chat with AI Assistant</h1>
        <p className="text-gray-400 text-center mb-8 max-w-2xl mx-auto text-responsive-sm">
          Get help with interview preparation, technical questions, and career advice from our AI assistant.
        </p>
        
        <div className="h-[600px] sm:h-[650px] md:h-[700px] mb-8 transition-all duration-300">
          <Suspense fallback={<ChatbotLoading />}>
            <Chatbot />
          </Suspense>
        </div>
        
        <div className="bg-gray-800/50 rounded-xl p-responsive-sm border border-gray-700 shadow-elegant">
          <h2 className="text-responsive-lg font-semibold mb-4 flex items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-gray-700/50 p-4 rounded-lg border border-gray-700/50 hover:border-indigo-500/30 transition-all duration-300">
